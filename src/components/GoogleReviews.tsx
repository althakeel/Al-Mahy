...
export default function GoogleReviews({ locale }: { locale: Locale }) {
  ...
  const content = {
    en: {
      ...
      subtitle: "Trusted by individuals and businesses across the UAE for professional legal and corporate services.",
      ...
      <div className="max-w-[1250px] mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <div className="flex justify-center mb-4">
            <div className="h-1 w-20 bg-[#DE3B34] rounded"></div>
          </div>
            ...
            >
              ...
              <div className="flex items-start gap-3 mb-4">
                {review.profilePhotoUrl ? (
                  ...
                  <div className="w-12 h-12 bg-gradient-to-br from-[#DE3B34] to-[#c73731] rounded-full flex items-center justify-center text-white font-bold text-sm flex-shrink-0">
                    {review.avatar}
                  </div>
                )}
        ...
        <div className="text-center">
          <a
            ...
            className="inline-flex items-center gap-3 bg-gradient-to-r from-[#DE3B34] to-[#c73731] hover:from-[#c73731] hover:to-[#9B0F09] text-white font-bold px-10 py-4 rounded-full transition-all hover:scale-105 shadow-xl"
          >
    ...
    ar: [
      {
        ...
        rating: 5,
        date: "قبل أسبوعين",
        text: "استشارة قانونية ممتازة. شرح فريق المحامي خياراتنا بوضوح، وراجع المستندات بعناية، وقدم لنا توجيها عمليا لقضيتنا في دبي. محترفون للغاية وسريعو الاستجابة.",
        avatar: "AM"
      },
      {
        id: 2,
      ...
      },
      {
        ...
        rating: 5,
        date: "قبل شهرين",
        text: "دعم محاسبي وضريبي احترافي وموثوق. ساعدتنا المحامي في تنظيم مسك الدفاتر وإقرارات ضريبة القيمة المضافة والتقارير المالية مع الحفاظ على الامتثال والوضوح.",
        avatar: "EC"
      },
      {
        id: 5,
