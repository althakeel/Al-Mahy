...
// Some existing deployments accidentally saved this key with a non-breaking-space
// prefix. Keep that configuration working while new deployments use the normal name.
