...
export const teamMembers: TeamMemberProfile[] = [
  ...
  basicProfile({
    ...
    positionAr: "محاسب",
    photo: cardPhoto("mudasir-yaseen", "/images/team/team-11.png"),
  ...
  basicProfile({
    ...
    positionEn: "ACCOUNTANT",
    positionAr: "محاسب",
    photo: cardPhoto("ahmed-osama", "/images/team/team-04.png"),
    practiceAreasEn: ["Accounting", "Bookkeeping", "Financial Reporting"],
    practiceAreasAr: ["المحاسبة", "مسك الدفاتر", "التقارير المالية"],
  }),
  basicProfile({
    ...
    positionEn: "ACCOUNTANT",
    positionAr: "محاسب",
    photo: cardPhoto("mahmoud-salah-eldein", "/images/team/team-05.png"),
    practiceAreasEn: ["Accounting", "Bookkeeping", "Financial Reporting"],
    practiceAreasAr: ["المحاسبة", "مسك الدفاتر", "التقارير المالية"],
  }),
  {
