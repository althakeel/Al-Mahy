...
export const teamMembers: TeamMemberProfile[] = [
  ...
  }),
  {
    ...
    photo: cardPhoto("mohamed-hassanein", "/images/team/mohamed-hassanein.png"),
  ...
  basicProfile({
    ...
    positionAr: "محاسب",
    photo: cardPhoto("mudasir-yaseen", "/images/team/team-05.png"),
  ...
  basicProfile({
    ...
    positionEn: "ACCOUNTANT",
    positionAr: "محاسب",
    photo: cardPhoto("omar-raafat", "/images/team/team-04.png"),
    practiceAreasEn: ["Accounting", "Bookkeeping", "Financial Reporting"],
    practiceAreasAr: ["المحاسبة", "مسك الدفاتر", "التقارير المالية"],
  }),
  basicProfile({
    slug: "mahmoud-salah-eldein",
    nameEn: "Mahmoud Salah Eldein Ahmed Kamel Abdelrahman",
    nameAr: "محمود صلاح الدين أحمد كامل عبد الرحمن",
    positionEn: "ACCOUNTANT",
    positionAr: "محاسب",
    photo: cardPhoto("mahmoud-salah-eldein", "/images/team/team-11.png"),
    practiceAreasEn: ["Accounting", "Bookkeeping", "Financial Reporting"],
    practiceAreasAr: ["المحاسبة", "مسك الدفاتر", "التقارير المالية"],
  }),
  {
